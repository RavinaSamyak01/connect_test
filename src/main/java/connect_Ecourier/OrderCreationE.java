...
public class OrderCreationE extends BaseInit {
	public static String rdytime, rectime, arrtime, tndrtime;

	public static String pck;
	public static String PICKUPID;
	public static String ECourierOrderNum;
	...
	public void orderCreation(int i)
		...
		try {
			...
			if (i < 10) {
				...
				String PUZip = getData("Sheet2", i, 3);
...
//				}
				...
				// --Del Zip
				String DLZip = getData("Sheet2", i, 11);
				...
				// String DLInst = getData("Sheet2", i, 17);
				...
				// --Weight
				String Weight = getData("Sheet2", i, 19);
				...
				// --Length
				String Len = getData("Sheet2", i, 20);
				...
				// --Width
				String Width = getData("Sheet2", i, 21);
				...
				// --Height
				String Height = getData("Sheet2", i, 22);
				...
				// --Commodity
				String Commodity = getData("Sheet2", i, 23);
				...
				setData("Sheet2", i, 25, pmi);
				setData("Sheet2", i, 27, dmi);
				setData("Sheet2", i, 29, tmile);
				...
				if (i == 3) {
					...
					try {
						...
						wait.until(ExpectedConditions
								.visibilityOfAllElementsLocatedBy(By.xpath("//*[@ng-form=\"FDXUPSFOrm\"]")));
						...
						logs.info(ee);
						logs.info("Issue in selecting Drop Off Location");
						getScreenshot(driver, "P3PDropOffLocation");
						refreshApp();
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(50));// wait time
			...
			if (i >= 10) {
				...
				// --Get the ServiceID
				String ServID = getData("Sheet2", i, 18);
	...
	public void compareCourier(int i, String SVC)
		...
		String ExpCourierID = getData("Sheet2", i, 38);
	...
	public void searchJob(int i) throws Exception {
		...
		try {
			...
			String PUID = getData("Sheet2", i, 32);
	...
	public void selectFlight() throws InterruptedException {
		...
		//Search for delta air line 
		WebElement Filter = isElementPresent("Filterairline_id");
		Filter.click();
		Thread.sleep(2000);
		Filter.sendKeys("DL");
		logs.info("Entered DL in AirLine Filter text box");
		
		//Click on Request root 
		WebElement RequestRoute = isElementPresent("RequestRoot_id");
		wait.until(ExpectedConditions.elementToBeClickable(RequestRoute));
		act.moveToElement(RequestRoute).build().perform();
		js.executeScript("arguments[0].click();", RequestRoute);
		logs.info("Clicked on Request Route");
...
//		js.executeScript("arguments[0].click();", AssignFlight);
		act.moveToElement(AssignFlight).click().perform();
		logs.info("Clicked on Assign button");
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("loaderDiv")));
		try {
		//Pop-Up
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='ng-scope'])[5]")));
		WebElement Yes = isElementPresent("ChangeAirportPopUp_xpath");
		wait.until(ExpectedConditions.elementToBeClickable(Yes));
		act.moveToElement(Yes).build().perform();
		js.executeScript("arguments[0].click();", Yes);
		logs.info("Clicked on Yes To Change delivery Airport");
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("loaderDiv")));}
		catch(Exception popup) {
			
			logs.info("Change airport not exixt");
		}
	...
	public static void inventorySearch(int i)
		...
		String PartName = getData("Sheet2", i, 37);
	...
	public String shipLabel() throws IOException, InterruptedException {
		...
		try {
			...
			logs.info("There is no Ship Label");
...
//Job Status
		WebElement JobStatus = driver.findElement(By.xpath("//div[text()='Job Status']"));
		wait.until(ExpectedConditions.visibilityOf(JobStatus));
		wait.until(ExpectedConditions.elementToBeClickable(JobStatus));
		jse.executeScript("arguments[0].click();", JobStatus);
		logs.info("Clicked on Job Status");

	}

	
	public void SearchPICKUPID_after_reject_utility() throws Exception {
		JavascriptExecutor jse = (JavascriptExecutor) driver;// scroll,click
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));// wait time
		Actions act = new Actions(driver);
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("loaderDiv")));
...
//Enter Pickup id 
		...
		String expectedText = "SENDPUALERT";
		int maxAttempts = 30;
...
//Search 
		...
		wait.until(ExpectedConditions.elementToBeClickable(Search));
		jse.executeScript("arguments[0].click();", Search);
		logs.info("Clicked on Search and waiting for "+ expectedText +" text");
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("loaderDiv")));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='ng-scope'])[2]")));
		Thread.sleep(1500);
		    ...
		    WebElement element = driver.findElement(By.xpath("//span[@id='lblNextTaskValue_0']"));
		    String next_task = element.getText();
		    if (next_task.equalsIgnoreCase(expectedText)) {
...
//Job Status
	...
	public void getEcourierID() throws Exception {
		

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));// wait time
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("idQuoteMemoList")));
		WebElement MemoText = isElementPresent("MemoTxt_xpath");
		wait.until(ExpectedConditions.visibilityOf(MemoText));
		String EcourierText = MemoText.getAttribute("value");
		System.out.println("Ecourier Number:-" + EcourierText);
		logs.info("Extracted Memo full text");
		String ECourierOrderNum = EcourierText.replaceAll("[^0-9]", "");
		System.out.println(ECourierOrderNum);
		
		this.ECourierOrderNum = ECourierOrderNum;
		logs.info("Extracted Ecoutier ID:-"+ECourierOrderNum);	
		
		msg.append("E-Courier Order Number is:-"+ECourierOrderNum + "\n");

		WebElement PickUPID = driver.findElement(By.xpath("//span[@class='text-green ng-binding']"));
		String PICKUPID = PickUPID.getText();
		this.PICKUPID = PICKUPID;
		System.out.println("Pick Up ID with Prefix:-" + PICKUPID);
		logs.info("Extracted Pick Up ID with Prefix");

	}
	
	  public void searchPickUpID() {
		...
		// --Go to Operation
					...
					act.moveToElement(TaskLog).click().build().perform();
					wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("loaderDiv")));
					wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='row TasklogMasterpanel']")));
				     logs.info("Click on Tasklog");
		  //  basic search
					WebElement BasicSearch = isElementPresent("BasicSearch_id");
					wait.until(ExpectedConditions.visibilityOf(BasicSearch));
//					wait.until(ExpectedConditions.elementToBeClickable(BasicSearch));
//					js.executeScript("arguments[0].click();", BasicSearch);
					BasicSearch.sendKeys(pck);
					logs.info("Entered Pickup id");
					
					//Search button
					WebElement Searchbttn = isElementPresent("searchButton_id");
					wait.until(ExpectedConditions.visibilityOf(Searchbttn));
					wait.until(ExpectedConditions.elementToBeClickable(Searchbttn));
					act.moveToElement(Searchbttn).click().build().perform();
					logs.info("Clicked on PICKUP ID Search Button ");
