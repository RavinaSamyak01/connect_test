...
public class PA extends OrderCreation {
	...
	public void paPriorityAir() throws Exception {
		/*
		 * JavascriptExecutor jse = (JavascriptExecutor) driver; WebDriverWait wait =
		 * new WebDriverWait(driver, Duration.ofSeconds(50));// wait time Actions act = new Actions(driver);
		 */
